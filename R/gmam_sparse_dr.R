...
gmam_sparse_dr <- 
  function(Y,X,group=NULL,K_index=NULL,r1_index=NULL,r2_index=NULL,r3_index=NULL,method="BIC",ncv=10,penalty="LASSO",lambda=NULL,
    ...
    #---------------- The selection by CV  ---------------------#  
    if(method=="BIC") fit_dr = gmam_sparse_bic(Y,X,group,K_index,r1_index,r2_index,r3_index,lambda,D0,intercept,opts,opts_pen)
    if(method=="CV") fit_dr = gmam_sparse_cv(Y,X,group,ncv,K_index,r1_index,r2_index,r3_index,lambda,D0,intercept,opts,opts_pen)
