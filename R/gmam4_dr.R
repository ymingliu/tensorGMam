...
gmam4_dr <- function(Y,X,group=NULL,method="BIC",ncv=10,K_index=NULL,r1_index=NULL,r2_index=NULL,r3_index=NULL,
  ...
  if(is.null(r3_index)) r3_index = 1:min(ceiling(log(n)),G)
  if(is.null(r4_index)) r4_index = 1:min(ceiling(log(n)),q)
  ...
  opts = list(eps=eps,eps1=eps1,max_step=max_step,max_step1=max_step1,n=n,r1=2,r2=2,r3=2,r4=2,p=p,q=q,degr=degr,K=max(K_index),G=G)
  if(method=="BIC") fit_dr = gmam4_bic(Y,X,group,K_index,r1_index,r2_index,r3_index,r4_index,D0,intercept,opts)
  if(method=="CV") fit_dr = gmam4_cv(Y,X,group,ncv,K_index,r1_index,r2_index,r3_index,r4_index,D0,intercept,opts)
  return(fit_dr)
}